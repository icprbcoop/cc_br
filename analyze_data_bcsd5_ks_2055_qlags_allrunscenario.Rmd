...
prrism_flows_ccall <- left_join(prrism_flows_orig.df, 
  ...
  mutate(jrr_inflow = round(jrr_inflow*qscaleall_to2055,1),
         ...
         sen_inflow = round(sen_inflow*qscaleall_to2055,1),
         ...
         beaverdam_inflow = round(beaverdam_inflow*qscaleall_to2055,1),
         goose_inflow = round(goose_inflow*qscaleall_to2055,1),
         manassas_nat_inflow = round(manassas_nat_inflow*qscaleall_to2055,1)) %>%
    select(-date_time, -quantiles, -q_mm, -q_obs_frac, -qscaleall_to1995,
